<template>
  <div class="quiz-container">
      ...
      <div class="options">
        <label
          ...
          :class="{
            ...
            'incorrect-answer':
              reviewMode && q.selected === opt && q.selected !== q.correct,
          }"
        >
          <input
            type="radio"
    ...
    <button v-if="!reviewMode" @click="submitQuiz" class="submit-button">
      Submit
    </button>
    <button v-else @click="restartQuiz" class="submit-button">
      Retake Quiz
    </button>
  </div>
